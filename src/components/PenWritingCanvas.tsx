...
import { Volume2, Eraser, RotateCcw, CheckCircle2, Sparkles, Pencil, ArrowRight, ShoppingBag, AlertCircle, Target, Navigation, MoveDownRight, Layers, ZoomIn } from 'lucide-react';
  ...
  return (
    <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm dir-rtl">
      ...
      <div className="relative w-full h-[280px] bg-slate-50 rounded-2xl border border-dashed border-slate-300 overflow-hidden flex items-center justify-center select-none">
        ...
        <div className="absolute top-3 left-4 z-20 bg-white/90 text-slate-700 text-[11px] font-semibold px-2.5 py-1 rounded-lg border border-slate-200 flex items-center gap-1.5 font-['Outfit']" dir="ltr">
          <span>LTR ➔</span>
